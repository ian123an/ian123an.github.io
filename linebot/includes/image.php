...
if (strtolower($message['text']) == "image" || $message['text'] == "圖片") {
    $client->replyMessage(array(
        ...
        'messages' => array(
            array(
                'type' => 'image', //訊息類型 (圖片)
                'originalContentUrl' => 'https://d863-114-32-122-15.jp.ngrok.io/photo/logo.png', //回覆圖片
                'previewImageUrl' => 'https://d863-114-32-122-15.jp.ngrok.io/photo/logo.png' //回覆的預覽圖片
            )
        )
    ));
}
